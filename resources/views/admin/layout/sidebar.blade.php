<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #F89CAB">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#s_attribute" aria-expanded="true"
            ...
            <span style="font-weight: bold;">Quản lý Shop Attribute</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#products" aria-expanded="true"
            ...
            <i class="fas fa-solid fa-cart-plus"></i>
            <span style="font-weight: bold;">Quản lý sản phẩm</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('orders.index')}}">
            ...
            <span style="font-weight: bold;">Quản lý dơn hàng</span></a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#attribute" aria-expanded="true"
            ...
            <i class="fas fa-solid fa-cart-plus"></i>
            <span style="font-weight: bold;">Quản lý thuộc tính</span>
        </a>
